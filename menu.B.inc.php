...
<div class="freebak-menu">
	<div class="menu-button"><svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#fff"><path d="M160-780v-60h640v60H160Z"/></svg>
</div>
	<div class="mnu">
		<ul>
			<?
