...
<div class="menu-button"> <svg id="icon" xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#ffffff">
        <path d="M589.67-480.67 782.67-674l-73.34-73.33L442.67-480.67l266.66 266.67 73.34-73.33-193-193.34Zm-267 0L516-674l-73.33-73.33L176-480.67 442.67-214 516-287.33 322.67-480.67Z"/>
    </svg> </div>
